#!/usr/bin/env node
/**
 * skill/scripts/components.mjs — minimal, zero-deps CLI over the per-component
 ...
 *
 * Examples:
 *   node skill/scripts/components.mjs                           — all tags, full meta as markdown
 *   node skill/scripts/components.mjs --tag ce-card             — one tag, full meta
 *   node skill/scripts/components.mjs --tag ce-card --tag ce-rating
 *   node skill/scripts/components.mjs --group "Chat surfaces"   — filter by manifest group (= meta.tags[0])
 *   node skill/scripts/components.mjs --category ui
 *   node skill/scripts/components.mjs --tier brick
 *   node skill/scripts/components.mjs --fields tag,goal,events  — project subset
 *   node skill/scripts/components.mjs --format json
 *
...
const HELP = `Usage: node skill/scripts/components.mjs [flags]
