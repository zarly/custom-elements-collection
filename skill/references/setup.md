...
The same files are queryable from a CLI: `node node_modules/custom-elements-collection/dist/meta/index.json | jq '...'`, or from the repo via `node skill/scripts/components.mjs --help`.
